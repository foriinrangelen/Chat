import { Controller, Get, UseGuards, Post, Body, Param, Query, UseInterceptors, UploadedFiles, ParseIntPipe } from '@nestjs/common';
...
export class ChannelsController {
	...
	async getWorkspaceChannelChats(@Param('url') url, @Param('name') name, @Query('perPage', ParseIntPipe) perPage: number, @Query('page', ParseIntPipe) page: number) {
	...
	async createWorkspaceChannelChats(@Param('url') url, @Param('name') name, @Body('content') content, @User() user: Users) {
